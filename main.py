...
class ProblemManager:
	def __init__(self):
		...
		self.threat_list = []
		self.solution_vals = []
		with open(path.join(path.dirname(executable), 'Resources/callsigns.txt'), 'r') as file:
...
with open(path.join(path.dirname(executable), 'Resources/config.toml'), 'rb') as file:

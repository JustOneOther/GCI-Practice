...
class PySRHandler:
	def __init__(self):
		...
		self.config['lm'] = path.join(path.dirname(executable), 'Resources/lang_model/0889.lm')
		self.config['dict'] = path.join(path.dirname(executable), 'Resources/lang_model/0889.dic')
